...
cube_prim_1 = DynamicCuboid(                              # 4. Prim
...
cube_prim_2 = DynamicCuboid(                              # 4. Prim
...
cube_prim_3 = DynamicCuboid(                              # 4. Prim
...
world.scene.add(cube_prim_1)
world.scene.add(cube_prim_2)
world.scene.add(cube_prim_3)
